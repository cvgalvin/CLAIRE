...
11.expensive scoring binding metrics (preorganization, molecular contact surface, etc.)
12.mpnn on non binding site positions
13.fastdesign with mpnn seq profile - score stability metrics 
14.colabfold
15.score all metrics repeat
'''
...
USES LOCAL COPY OF PDBREDO DATABASE, MUST MANUALLY CHANGE PATH IN SCRIPT TO LOCATION IN YOUR SYSTEM
'''
